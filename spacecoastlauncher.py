import requests
from main import EventHandler as eh
...
def object_generator(dates,vehicles,missions,sites,times):
	for value in zip(dates,vehicles,missions,sites,times):
		object = eh(name=None,date=None,desc=None,site=None,company=None,live=None)
...
if __name__ == "__main__":
	data = eh(name='Test',date=None,desc=None,site=None,company=None,live=None)
